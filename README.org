...
#+begin_src lisp
  ...
  (defvar *equake-height-percentage* 40)
  (defvar *equake-width-percentage* 100)
  ...
  (defcommand invoke-equake () ()
    ...
    (let* ((on-top-windows (group-on-top-windows (current-group)))
           ...
           (equake-width (round (* *equake-width-percentage* (car (calc-screen-dimensions))))
           (equake-height (round (* *equake-height-percentage* (cadr (calc-screen-dimensions))))))
